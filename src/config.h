...
typedef struct {
    char *log_level;
    char *log_file;          // Where to write the log (NULL = platform default)
...
typedef struct {
    sfs_server_config server;
    sfs_share_config *shares;
    size_t share_count;
    sfs_printer_config *printers;
    size_t printer_count;
    sfs_mime_entry *mimemap;
